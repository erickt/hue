...
<div class="navigator">
  ...
  <a class="brand nav-tooltip pull-left" href="#"><img src="${ STATIC_URL }/desktop/art/hue-logo-mini-white.png"
                                                       data-orig="${ STATIC_URL }/desktop/art/hue-logo-mini-white.png"
                                                       data-hover="${ STATIC_URL }/desktop/art/hue-logo-mini-white-hover.png"/></a>
  ...
  <div class="row">
    <div class="login-content">
      <form method="POST" action="${action}" class="well">
        ...
        <img id="logo" src="${ STATIC_URL }/desktop/art/hue-login-logo.png" data-orig="${ STATIC_URL }/desktop/art/hue-login-logo.png"
             data-hover="${ STATIC_URL }/desktop/art/hue-login-logo-skew.png"/>
