...
<head>
  ...
  <link href="${ STATIC_URL }/desktop/ext/css/bootplus.css" rel="stylesheet">
  <link href="${ STATIC_URL }/desktop/ext/css/font-awesome.min.css" rel="stylesheet">
  <link href="${ STATIC_URL }/desktop/css/hue3.css" rel="stylesheet">
  <link href="${ STATIC_URL }/desktop/ext/css/fileuploader.css" rel="stylesheet">
  ...
  <script src="${ STATIC_URL }/desktop/ext/js/jquery/jquery-2.1.1.min.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.migration.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.filechooser.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.selector.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.delayedinput.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.rowselector.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.notify.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.titleupdater.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.tablescroller.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.tableextender.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.scrollup.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.tour.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.cookie.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.total-storage.min.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.placeholder.min.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.dataTables.1.8.2.min.js"></script>
  <script src="${ STATIC_URL }/desktop/js/jquery.datatables.sorting.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/bootstrap.min.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/bootstrap-better-typeahead.min.js"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/fileuploader.js"></script>
  <script src="${ STATIC_URL }/desktop/js/popover-extra-placements.js"></script>
...
<div class="navigator">
  ...
  % endif
    ...
    <a class="brand nav-tooltip pull-left" title="${_('About Hue')}" rel="navigator-tooltip" href="/about"><img src="${ STATIC_URL }/desktop/art/hue-logo-mini-white.png" data-orig="${ STATIC_URL }/desktop/art/hue-logo-mini-white.png" data-hover="${ STATIC_URL }/desktop/art/hue-logo-mini-white-hover.png" /></a>
    % if user.is_authenticated() and section != 'login':
         ...
         <ul role="menu" class="dropdown-menu">
           <li class="dropdown-submenu">
             ...
             <ul class="dropdown-menu">
               ...
               <li><a href="${url('oozie:list_oozie_bundles')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_bundle_48.png" class="app-icon" /> ${_('Bundles')}</a></li>
             </ul>
           </li>
           <% from oozie.conf import ENABLE_V2 %>
           % if not ENABLE_V2.get():
           <li class="dropdown-submenu">
             <a href="${ url('oozie:list_workflows') }"><img src="${ STATIC_URL }/oozie/art/icon_oozie_editor_48.png" class="app-icon" /> ${_('Editors')}</a>
             <ul class="dropdown-menu">
               <li><a href="${url('oozie:list_workflows')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_workflow_48.png" class="app-icon"/> ${_('Workflows')}</a></li>
               <li><a href="${url('oozie:list_coordinators')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_coordinator_48.png" class="app-icon" /> ${_('Coordinators')}</a></li>
               <li><a href="${url('oozie:list_bundles')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_bundle_48.png" class="app-icon" /> ${_('Bundles')}</a></li>
             </ul>
           </li>
           % else:
           <li class="dropdown-submenu">
             <a href="${ url('oozie:list_editor_workflows') }"><img src="${ STATIC_URL }/oozie/art/icon_oozie_editor_48.png" class="app-icon" /> ${_('Editors')}</a>
             <ul class="dropdown-menu">
               <li><a href="${url('oozie:list_editor_workflows')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_workflow_48.png" class="app-icon"/> ${_('Workflows')}</a></li>
               <li><a href="${url('oozie:list_editor_coordinators')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_coordinator_48.png" class="app-icon" /> ${_('Coordinators')}</a></li>
               <li><a href="${url('oozie:list_editor_bundles')}"><img src="${ STATIC_URL }/oozie/art/icon_oozie_bundle_48.png" class="app-icon" /> ${_('Bundles')}</a></li>
             </ul>
           </li>
           % endif
         </ul>
