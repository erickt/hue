...
<style type="text/css">
  ...
  #logo {
    ...
    margin-right: auto;
    margin-bottom: 10px;
    background: #FFF url("${ STATIC_URL }/desktop/art/hue-login-logo-ellie.png") 50% 2px no-repeat;
    width: 130px;
    height: 130px;
  ...
  @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
    #logo {
      background: #FFF url("${ STATIC_URL }/desktop/art/hue-login-logo-ellie@2x.png") 50% 2px no-repeat;
