...
<%def name="import_layout()">
  ...
  <script src="${ STATIC_URL }/desktop/js/ko.common-dashboard.js" type="text/javascript" charset="utf-8"></script>
...
<%def name="layout_skeleton()">
  ...
  <div style="float:left; padding-top: 90px; margin-right: 20px; text-align: center; width: 260px">${ _('Click on the pencil to get started with your dashboard!') }</div>
    <img src="${ STATIC_URL }/desktop/art/hint_arrow.png" />
  </div>
  ...
  <div id="emptyDashboardEditing" data-bind="fadeVisible: isEditing() && columns().length == 0 && previewColumns() == ''">
    ...
    <img src="${ STATIC_URL }/desktop/art/hint_arrow_horiz_flipped.png" />
  </div>
...
<script type="text/html" id="row-template">
  <div class="emptyRow" data-bind="visible: widgets().length == 0 && $index() == 0 && $root.isEditing() && $parent.size() > 4 && $parent.rows().length == 1">
    <img src="${ STATIC_URL }/desktop/art/hint_arrow_flipped.png" style="float:left; margin-right: 10px"/>
...
<%def name="import_bindings()">
  <link rel="stylesheet" href="${ STATIC_URL }/desktop/css/freshereditor.css">
  ...
  <link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/bootstrap-datepicker.min.css">
  <link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/bootstrap-timepicker.min.css">
  <link rel="stylesheet" href="${ STATIC_URL }/desktop/css/bootstrap-spinedit.css">
  <link rel="stylesheet" href="${ STATIC_URL }/desktop/css/bootstrap-slider.css">

  <script src="${ STATIC_URL }/desktop/ext/js/bootstrap-datepicker.min.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/bootstrap-timepicker.min.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/js/bootstrap-spinedit.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/js/bootstrap-slider.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/js/freshereditor.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/codemirror-3.11.js" type="text/javascript" charset="utf-8"></script>
  <script src="${ STATIC_URL }/desktop/ext/js/codemirror-xml.js" type="text/javascript" charset="utf-8"></script>

  <script src="${ STATIC_URL }/desktop/ext/js/less-1.7.0.min.js" type="text/javascript" charset="utf-8"></script>
