        ...
        <ul class="nav">
          <li class="currentApp">
            <a href="${ url('desktop.views.home') }">
              <img src="${ STATIC_URL }/desktop/art/home.png" class="app-icon" />
              ${ _('My documents') }
            </a>
           </li>
        </ul>
          ...
          <li class="nav-header">${_('Actions')}</li>
           <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                % if 'beeswax' in apps:
                <li><a href="${ url('beeswax:index') }"><img src="${ STATIC_URL }${ apps['beeswax'].icon_path }" class="app-icon"/> ${_('Hive Query')}</a></li>
                % endif
                % if 'impala' in apps:
                <li><a href="${ url('impala:index') }"><img src="${ STATIC_URL }${ apps['impala'].icon_path }" class="app-icon"/> ${_('Impala Query')}</a></li>
                % endif
                % if 'pig' in apps:
                <li><a href="${ url('pig:index') }"><img src="${ STATIC_URL }${ apps['pig'].icon_path }" class="app-icon"/> ${_('Pig Script')}</a></li>
                % endif
                % if 'spark' in apps:
                <li><a href="${ url('spark:index') }"><img src="${ STATIC_URL }${ apps['spark'].icon_path }" class="app-icon"/> ${_('Spark Job')}</a></li>
                % endif
                % if 'oozie' in apps:
                <li class="dropdown-submenu">
                  <a href="#"><img src="${ apps['oozie'].icon_path }" class="app-icon"/> ${_('Oozie Scheduler')}</a>
                  <ul class="dropdown-menu">
                    <li><a href="${ url('oozie:create_workflow') }"><img src="${ STATIC_URL }/oozie/art/icon_oozie_workflow_48.png" class="app-icon"/> ${_('Workflow')}</a></li>
                    <li><a href="${ url('oozie:create_coordinator') }"><img src="${ STATIC_URL }/oozie/art/icon_oozie_coordinator_48.png" class="app-icon"/> ${_('Coordinator')}</a></li>
                    <li><a href="${ url('oozie:create_bundle') }"><img src="${ STATIC_URL }/oozie/art/icon_oozie_bundle_48.png" class="app-icon"/> ${_('Bundle')}</a></li>
                  </ul>
                </li>
                % endif
              </ul>
...
<script src="${ STATIC_URL }/desktop/js/home.vm.js"></script>
