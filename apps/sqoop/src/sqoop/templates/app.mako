...
<div class="container-fluid">
  ...
  <div class="row-fluid" data-bind="if: isLoading">
    <div class="span10 offset1 center" style="margin-top: 30px">
      <!--[if lte IE 9]>
        <img src="${ STATIC_URL }/desktop/art/spinner-big.gif" />
      <![endif]-->
      <!--[if !IE]> -->
...
<script src="${ STATIC_URL }/desktop/ext/js/datatables-paging-0.1.js" type="text/javascript" charset="utf-8"></script>
...
<script src="${ STATIC_URL }/desktop/ext/js/bootstrap-editable.min.js"></script>
<script src="${ STATIC_URL }/desktop/js/ko.editable.js"></script>
<script src="${ STATIC_URL }/desktop/js/jquery.hdfsautocomplete.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/cclass.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/koify.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.autocomplete.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.utils.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.wizard.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.configs.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.driver.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.connectors.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.links.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.jobs.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.submissions.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/sqoop/js/sqoop.js" type="text/javascript" charset="utf-8"></script>

<link href="${ STATIC_URL }/desktop/ext/css/bootstrap-editable.css" rel="stylesheet">
<link href="${ STATIC_URL }/sqoop/css/sqoop.css" rel="stylesheet">
