...
<link href="${ STATIC_URL }/desktop/jobbrowser/css/jobbrowser.css" rel="stylesheet">
...
<div class="container-fluid">
  ...
  <%actionbar:render>
    <%def name="search()">
      ...
      <img id="loading" src="${ STATIC_URL }/desktop/art/spinner.gif" />
    </%def>
...
<script src="${ STATIC_URL }/desktop/jobbrowser/js/utils.js" type="text/javascript" charset="utf-8"></script>
