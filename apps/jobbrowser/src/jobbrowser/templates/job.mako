...
<link href="${ STATIC_URL }/jobbrowser/css/jobbrowser.css" rel="stylesheet">
...
<script src="${ STATIC_URL }/jobbrowser/js/utils.js" type="text/javascript" charset="utf-8"></script>
