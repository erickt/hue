...
<link rel="stylesheet" href="${ STATIC_URL }/oozie/css/common-editor.css">
<link rel="stylesheet" href="${ STATIC_URL }/oozie/css/coordinator-editor.css">

<link href="${ STATIC_URL }/desktop/css/jqCron.css" rel="stylesheet" type="text/css" />
<script src="${ STATIC_URL }/desktop/js/jqCron.js" type="text/javascript"></script>
...
<script src="${ STATIC_URL }/oozie/js/coordinator-editor.ko.js" type="text/javascript" charset="utf-8"></script>
