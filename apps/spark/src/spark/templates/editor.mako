...
<link rel="stylesheet" href="${ STATIC_URL }/desktop/css/common_dashboard.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/codemirror.css">
<link rel="stylesheet" href="${ STATIC_URL }/spark/css/spark.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/bootstrap-editable.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/chosen/chosen.min.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/hue-charts.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/leaflet.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/nv.d3.min.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/css/nv.d3.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/select2/select2.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/medium-editor.min.css">
<link rel="stylesheet" href="${ STATIC_URL }/desktop/css/bootstrap-medium-editor.css">


<script src="${ STATIC_URL }/desktop/ext/js/codemirror-3.11.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-pig.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-hql.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-python.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-clike.js"></script>

<script src="${ STATIC_URL }/desktop/js/codemirror-show-hint.js"></script>

<script src="${ STATIC_URL }/desktop/js/codemirror-isql-hint.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-hql-hint.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-pig-hint.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-python-hint.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-clike-hint.js"></script>

<script src="${ STATIC_URL }/desktop/ext/js/markdown.min.js"></script>
<script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.hotkeys.js"></script>

<script src="${ STATIC_URL }/desktop/ext/js/bootstrap-editable.min.js" type="text/javascript" charset="utf-8"></script>
...
<script src="${ STATIC_URL }/desktop/js/ko.editable.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/hue.utils.js"></script>
<script src="${ STATIC_URL }/desktop/js/ko.hue-bindings.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/spark/js/assist.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/spark/js/spark.ko.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/ext/chosen/chosen.jquery.min.js" type="text/javascript" charset="utf-8"></script>


<script src="${ STATIC_URL }/desktop/js/hue.geo.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/hue.colors.js" type="text/javascript" charset="utf-8"></script>

<script src="${ STATIC_URL }/desktop/ext/js/leaflet/leaflet.js" type="text/javascript" charset="utf-8"></script>

<script src="${ STATIC_URL }/desktop/ext/js/d3.v3.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/ext/js/topojson.v1.min.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/ext/js/topo/world.topo.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/ext/js/topo/usa.topo.js" type="text/javascript" charset="utf-8"></script>

<script src="${ STATIC_URL }/desktop/js/nv.d3.datamaps.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.legend.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.multiBarWithBrushChart.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.lineWithBrushChart.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingDiscreteBar.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingDiscreteBarChart.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingMultiBar.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingMultiBarChart.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingPie.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.growingPieChart.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.scatter.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/nv.d3.scatterChart.js" type="text/javascript" charset="utf-8"></script>

<script src="${ STATIC_URL }/desktop/js/ko.charts.js" type="text/javascript" charset="utf-8"></script>

<script src="${ STATIC_URL }/desktop/ext/select2/select2.min.js" type="text/javascript" charset="utf-8"></script>

<!--[if IE 9]>
  <script src="${ STATIC_URL }/desktop/ext/js/classList.min.js" type="text/javascript" charset="utf-8"></script>  
<![endif]-->
<script src="${ STATIC_URL }/desktop/ext/js/medium-editor.min.js" type="text/javascript" charset="utf-8"></script>
...
<div id="assistQuickLook" class="modal hide fade">
    ...
    <div class="modal-body" style="min-height: 100px">
      <div class="loader">
        ...
        <!--[if IE]><img src="${ STATIC_URL }/desktop/art/spinner.gif"/><![endif]-->
      </div>
  ...
  <div class="row-fluid">
    <div data-bind="css: klass, attr: {'id': 'snippet_' + id()}">
      ...
      <h2 class="card-heading simple" data-bind="visible: $root.isEditing() || (! $root.isEditing() && type() != 'text')">
        ...
        <!-- ko if: type() == 'hive' -->
        <img src="${ STATIC_URL }/beeswax/art/icon_beeswax_48.png" class="snippet-icon">
        <!-- /ko -->

        <!-- ko if: type() == 'impala' -->
        <img src="${ STATIC_URL }/impala/art/icon_impala_48.png" class="snippet-icon">
        <!-- /ko -->

        <!-- ko if: type() == 'scala' -->
        <img src="${ STATIC_URL }/spark/art/icon_spark_48.png" class="snippet-icon"><sup style="color: #338bb8; margin-left: -2px">scala</sup>
        <!-- /ko -->

        <!-- ko if: type() == 'python' -->
        <img src="${ STATIC_URL }/spark/art/icon_spark_48.png" class="snippet-icon"><sup style="color: #338bb8; margin-left: -2px">python</sup>
        <!-- /ko -->

        <!-- ko if: type() == 'sql' -->
        <img src="${ STATIC_URL }/spark/art/icon_spark_48.png" class="snippet-icon"><sup style="color: #338bb8; margin-left: -2px">sql</sup>
        <!-- /ko -->

        <!-- ko if: type() == 'pig' -->
        <img src="${ STATIC_URL }/pig/art/icon_pig_48.png" class="snippet-icon">
        <!-- /ko -->
