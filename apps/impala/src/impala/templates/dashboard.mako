...
<link rel="stylesheet" href="${ STATIC_URL }/impala/css/impala-dashboard.css">
...
<script src="${ STATIC_URL }/impala/js/impala-dashboard.ko.js" type="text/javascript" charset="utf-8"></script>
