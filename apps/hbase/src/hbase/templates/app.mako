...
<link href="${ STATIC_URL }/hbase/css/hbase.css" rel="stylesheet" type="text/css" />
    ...
    <div class="container-fluid">
      <div class="nav-collapse">
        <ul class="nav">
          <li class="currentApp">
            <a href="/${app_name}">
              <img src="${ STATIC_URL }/hbase/art/icon_hbase_48.png" class="app-icon" />
              ${ _('HBase Browser') }
            </a>
          </li>
        </ul>
...
<%def name="smartview(datasource)">
  <div class="smartview" data-bind="foreach: ${datasource}.items(), css: { 'gridView': ${datasource}.showGrid() }">
    <div class="smartview-row" data-bind="css:{selected:$data.isSelected()}, visible: $data.items().length > 0 || $data.isLoading()">
      <h5 data-bind="click: lockClickOrigin($data.select, $element)"><code class="row_key" data-bind="text: $data.row.slice(0, 100) + ($data.row.length > 100 ? '...' : '')"></code> <i class="fa fa-check-square" data-bind="visible:$data.isSelected()"></i> <img data-bind="visible: $data.isLoading()" src="${ STATIC_URL }/desktop/art/spinner.gif" />
      ...
      <ul class="smartview-cells" data-bind="event: {scroll: onScroll}">
        ...
        <li data-bind="css: {'active': $data.isSelected()}, click: $data.select">
          <div>
            ...
            <img src="${ STATIC_URL }/desktop/art/spinner.gif" data-bind="visible: $data.isLoading() " />
          </div>
        </li>
        <!-- /ko -->
      </ul>
  ...
  <!--[if IE]><img src="${ STATIC_URL }/desktop/hbase/art/loader.gif" /><![endif]-->
  </center>
          ...
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="nav nav-list cell-history">
                ...
                <!-- /ko -->
                <li data-bind="visible: $data.content.history.loading()"><img src="${ STATIC_URL }/desktop/art/spinner.gif" /></li>
              </ul>
            </div>
          </div>
        </div>
...
<script src="${ STATIC_URL }/desktop/ext/js/codemirror-xml.js"></script>
<script src="${ STATIC_URL }/desktop/ext/js/codemirror-javascript.js"></script>
<link rel="stylesheet" href="${ STATIC_URL }/desktop/ext/css/codemirror.css">

<script src="${ STATIC_URL }/hbase/js/base.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/hbase/js/utils.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/hbase/js/api.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/hbase/js/controls.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/hbase/js/nav.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/hbase/js/app.js" type="text/javascript" charset="utf-8"></script>
