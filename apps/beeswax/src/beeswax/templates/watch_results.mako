...
<link href="${ STATIC_URL }/desktop/ext/css/leaflet.css" rel="stylesheet">
            ...
            <tbody>
             ...
             <div style="text-align: center; padding: 5px; height: 30px">
               <span class="noMore hide"
                     ...
                     src="${ STATIC_URL }/desktop/art/spinner.gif"
                     class="spinner"
                     style="display: none;"/>
             </div>
            % endif
...
<script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.flot.categories.min.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/ext/js/leaflet/leaflet.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/jquery.blueprint.js" type="text/javascript" charset="utf-8"></script>
