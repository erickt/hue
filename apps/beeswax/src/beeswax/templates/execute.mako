...
<div id="beeswax-execute">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="log">
            <div style="position:relative">
              ...
              <pre data-bind="visible: $root.design.watch.logs().length == 0">${_('There are currently no logs to visualize.')} <img src="${ STATIC_URL }/desktop/art/spinner.gif" data-bind="visible: $root.design.isRunning()"/></pre>
  ...
  <div id="saveResultsModal" class="modal hide fade">
    <div class="loader">
      ...
      <!--[if IE]><img class="spinner" src="${ STATIC_URL }/desktop/art/spinner-big-inverted.gif"/><![endif]-->
    </div>
...
<script src="${ STATIC_URL }/desktop/js/hue.json.js" type="text/javascript" charset="utf-8"></script>
...
<script src="${ STATIC_URL }/beeswax/js/beeswax.vm.js"></script>
...
<script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery-fieldselection.js" type="text/javascript"></script>
<script src="/beeswax/desktop/static/js/autocomplete.utils.js" type="text/javascript" charset="utf-8"></script>
