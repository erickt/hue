...
<div id="pig-editor-app">
        ...
        <div class="container-fluid">
          <div class="nav-collapse">
            <ul class="nav">
              <li class="currentApp">
                <a href="/${app_name}">
                  <img src="${ STATIC_URL }/pig/art/icon_pig_48.png" class="app-icon"/>
                  ${ _('Pig Editor') }
                </a>
              </li>
        ...
        <table class="table table-striped table-condensed tablescroller-disable" data-bind="visible: scripts().length > 0">
          ...
          <tr data-bind="visible: isLoading()">
            <td colspan="3" class="left">
              <img src="${ STATIC_URL }/desktop/art/spinner.gif" />
            </td>
          </tr>
    ...
    <div id="editor" class="row-fluid mainSection hide">
      ...
      <div class="span10">
        ...
        <div id="logs" class="section hide">
            ...
            <pre id="withoutLogs">${ _('No available logs.') } <img src="${ STATIC_URL }/desktop/art/spinner.gif" data-bind="visible: currentScript().isRunning()"/></pre>
  ...
  <div id="logsModal" class="modal hide fade">
    ...
    <div class="modal-body">
      <img src="${ STATIC_URL }/desktop/art/spinner.gif" class="hide" />
...
<script src="${ STATIC_URL }/pig/js/utils.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/pig/js/pig.ko.js" type="text/javascript" charset="utf-8"></script>
<script src="${ STATIC_URL }/desktop/js/share.vm.js" type="text/javascript" charset="utf-8"></script>
...
<script src="${ STATIC_URL }/beeswax/js/autocomplete.utils.js" type="text/javascript" charset="utf-8"></script>
% else:
...
<link rel="stylesheet" href="${ STATIC_URL }/pig/css/pig.css">
