...
<%def name="_table(files, path, current_request_path, view)">
  ...
  <link href="${ STATIC_URL }/filebrowser/css/listdir_components.css" rel="stylesheet" type="text/css">
  ...
  <script src="${ STATIC_URL }/desktop/js/jquery.hdfstree.js" type="text/javascript" charset="utf-8"></script>
  ...
  <script src="${ STATIC_URL }/desktop/js/dropzone.js" type="text/javascript" charset="utf-8"></script>
