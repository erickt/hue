...
<link href="${ STATIC_URL }/filebrowser/css/display.css" rel="stylesheet" />
...
<script src="${ STATIC_URL }/desktop/ext/js/jquery/plugins/jquery.visible.min.js" type="text/javascript" charset="utf-8"></script>
