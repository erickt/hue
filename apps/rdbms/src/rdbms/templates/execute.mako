...
<script src="${ STATIC_URL }/rdbms/js/rdbms.vm.js"></script>
...
<script src="${ STATIC_URL }/desktop/ext/js/codemirror-sql.js"></script>
<script src="${ STATIC_URL }/desktop/js/codemirror-sql-hint.js"></script>
...
<script src="${ STATIC_URL }/rdbms/js/autocomplete.utils.js" type="text/javascript" charset="utf-8"></script>
